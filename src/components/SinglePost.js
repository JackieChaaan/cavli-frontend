...
const SinglePost = ({className, post}) => {
    const {_id, title, imageUrl} = post
  return (
    <div className={className + ' outline-1'} style={{width:650}}>
      ...
      <div className="flex flex-row items-center space-x-4 cursor-pointer active:opacity-80">
        <FaUserAlt size={30} className='cursor-pointer hover:text-gray-900 active:text-gray-700 h-14 w-14 text-gray-700' />
